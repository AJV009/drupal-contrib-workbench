...
- Dependency injection used (see "Anti-Patterns" under Service & Dependency Injection).
...
- `\Drupal::` static calls in service classes (see "Anti-Patterns" under Service & Dependency Injection).
